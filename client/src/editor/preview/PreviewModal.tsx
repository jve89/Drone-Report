...
export default function PreviewModal({ draftId }: { draftId: string }) {
  ...
  useEffect(() => {
    ...
    // Dependencies exclude previewZoom to avoid reattaching on every zoom change.
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [closePreview, setPreviewZoom]);
    ...
    <div className="fixed inset-0 z-50">
      ...
      >
        ...
        <div className="h-12 flex items-center justify-between border-b px-3">
          <div id={titleId} className="text-sm font-medium">Preview</div>
        ...
        <div className="flex-1 overflow-auto bg-neutral-100">
          ...
          >
            <iframe
              ...
              src={`/api/drafts/${draftId}/preview`}
